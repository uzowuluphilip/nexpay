    ...
    <AuthenticatedLayout>
      <PageWrapper containerClassName="max-w-2xl mx-auto">
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-4xl sm:text-5xl font-bold mb-2">{t('wallet.title') || 'Wallet'}</h1>
          <p className="text-gray-600 dark:text-gray-400">{t('wallet.subtitle') || 'Manage your funds'}</p>
        </motion.div>
