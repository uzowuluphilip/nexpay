    ...
    <AuthenticatedLayout>
      <PageWrapper containerClassName="pt-8 pb-16">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h1 className="text-5xl sm:text-6xl font-bold mb-3 bg-gradient-to-r from-gray-900 to-gray-700 dark:from-white dark:to-gray-200 bg-clip-text text-transparent">
